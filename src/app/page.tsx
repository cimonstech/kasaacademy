...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-primary-container px-margin-mobile text-on-primary">
      <div
      ...
      <div className="relative z-10 flex max-w-lg flex-col items-center text-center">
        ...
        <div className="mt-10 h-px w-16 bg-secondary-fixed" aria-hidden="true" />

        <p className="mt-10 font-display text-[clamp(2rem,6vw,3.25rem)] leading-tight tracking-tight text-on-primary">
          Coming Soon
        </p>

        <p className="mt-5 max-w-sm text-base leading-relaxed text-on-primary-container/80">
        ...
        <Link
          href={site.cefPath}
          className="mt-10 inline-flex items-center gap-2 rounded-full border border-on-primary/25 px-6 py-3 text-sm font-bold tracking-wide text-on-primary transition-colors hover:border-secondary-fixed hover:text-secondary-fixed"
        >
      ...
      <p className="relative z-10 mt-16 text-xs tracking-[0.2em] text-on-primary-container/50 uppercase">
